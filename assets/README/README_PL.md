...
[Funkcje](#-kluczowe-funkcje) · [Jak zacząć](#-rozpocznij) · [Odkrywaj](#-odkrywaj-deeptutor) · [TutorBoty](#-tutorbot--trwali-autonomiczni-korepetytorzy-ai) · [CLI](#deeptutor-cli-agent-native-interface) · [Roadmapa](#%EF%B8%8F-harmonogram) · [Społeczność](#-społeczność--ekosystem)

[🇨🇳 中文](./README_CN.md) · [🇯🇵 日本語](./README_JA.md) · [🇪🇸 Español](./README_ES.md) · [🇫🇷 Français](./README_FR.md) · [🇸🇦 العربية](./README_AR.md) · [🇷🇺 Русский](./README_RU.md) · [🇮🇳 हिन्दी](./README_HI.md) · [🇵🇹 Português](./README_PT.md) · [🇹🇭 ภาษาไทย](./README_TH.md) · [🇵🇱 Polski](./README_PL.md)
...
> Pełny przewodnik po funkcjach i opis poleceń znajdziesz w [DeepTutor CLI](#deeptutor-cli-agent-native-interface).
...
<div align="center">
<img src="../figs/deeptutor-architecture.png" alt="Architektura DeepTutor" width="800">
</div>

### 💬 Czat — ujednolicone inteligentne środowisko pracy

<div align="center">
<img src="../figs/dt-chat.png" alt="Środowisko pracy czatu" width="800">
</div>
...
<div align="center">
<img src="../figs/dt-book-0.png" alt="Biblioteka książek" width="270"><img src="../figs/dt-book-1.png" alt="Czytnik książek" width="270"><img src="../figs/dt-book-2.png" alt="Animacja książki" width="270">
</div>
...
<div align="center">
<img src="../figs/dt-knowledge.png" alt="Zarządzanie wiedzą" width="800">
</div>
...
<div align="center">
<img src="../figs/dt-memory.png" alt="Pamięć" width="800">
</div>
...
<div align="center">
<img src="../figs/tutorbot-architecture.png" alt="Architektura TutorBota" width="800">
</div>
...
<div align="center">
<a id="deeptutor-cli-agent-native-interface"></a>

<img src="../figs/cli-architecture.png" alt="Architektura DeepTutor CLI" width="800">
</div>
